...
#Save response to a csv file, more dict readable
# slice to get the required amount/limit of quotes
# q is a dict -> convert it to str or json to avoid
# TypeError: write() must be str not dict
# Save it as a CSV
filename = "quotes.csv"
with open(f"./files/scraped_essentials/{filename}", mode='w', newline='', encoding='utf-8') as f:
...
#Save response to a txt file | Create a directory
